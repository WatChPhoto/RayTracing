...
void cone_test_scene() {
    ...
    // auto cone1_material = make_shared<lambertian>(color(0.9, 0.4, 0.2));
    // // world.add(make_shared<cone>(point3(400, 200, 300),V_cone, 75.0, interval(0.0, 200.0), cone1_material));
    // world.add(make_shared<sphere>(point3(400, 200, 300), 75, cone1_material));


    // auto cone2_material = make_shared<metal>(color(0.9, 0.4, 0.2), 0);
    // // world.add(make_shared<cone>(point3(200, 200, 300),V_cone, 75.0, interval(0.0, 200.0), cone2_material));
    // world.add(make_shared<sphere>(point3(200, 200, 300), 75, cone2_material));

    // auto cone3_material = make_shared<dielectric>(1.5);
    // // world.add(make_shared<cone>(point3(0, 200, 300),V_cone, 75.0, interval(0.0, 200.0), cone3_material));
    // world.add(make_shared<sphere>(point3(0, 200, 300), 75, cone3_material));
...
void reflector_example() {
    ...
    point3 V_cone = point3(0,1,0);
    V_cone = unit_vector(V_cone);
    point3 cone_tip = point3(500, 225, 300);

    auto cone_material = make_shared<metal>(color(0.8, 0.4, 0.3), 0);

    for (int i = 0; i < 5; i++) {
        V_cone += point3(0,0,-0.3);
        V_cone = unit_vector(V_cone);

        cone_tip += point3(-100,0,0); 

        world.add(make_shared<cone>(cone_tip,V_cone, 40.0, interval(100.0, 125.0), cone_material));
    }
    ...
    auto wall_material = make_shared<lambertian>(color(0.4, 0.4, 0.4));
    world.add(make_shared<quad>(point3(-1000,0,1000), vec3(2000,0,0), vec3(0,1000,0), wall_material));
...
int main() {
    switch (10) {
        ...
        case 11: reflector_example();         break; 
